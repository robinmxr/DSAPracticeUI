  ...
  <div className="space-y-8">
    ...
    <div className="relative mb-12 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="bg-gradient-to-br from-amber-500/8 via-amber-500/4 to-transparent backdrop-blur-sm border border-amber-500/15 rounded-3xl p-6 lg:p-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl flex items-center justify-center shadow-lg rotate-3">
                <Target className="text-white" size={20} />
              </div>
              <div>
                <h2 className="text-2xl lg:text-3xl font-bold text-white mb-1 bg-gradient-to-r from-white via-amber-100 to-orange-100 bg-clip-text text-transparent">
                  Algomist Study Guide
                </h2>
                <p className="text-amber-300 font-medium">Daily mastery in 6 weeks</p>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-gradient-to-br from-blue-500/8 via-blue-500/4 to-transparent backdrop-blur-sm border border-blue-500/15 rounded-3xl p-6 lg:p-8 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-white bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent">
                          Learn
                        </h3>
                        <p className="text-blue-300 mt-1">Build foundation</p>
                      </div>
                      <div className="ml-auto px-3 py-1.5 bg-blue-500/10 text-blue-300 rounded-full text-sm font-semibold border border-blue-500/20">
                        30-45 min
                      </div>
                    </div>
                    
                    <div className="bg-blue-500/8 border border-blue-500/15 rounded-2xl p-6">
                ...
                {/* Practice Phase */}
                <div className="bg-gradient-to-br from-emerald-500/8 via-emerald-500/4 to-transparent backdrop-blur-sm border border-emerald-500/15 rounded-3xl p-6 lg:p-8 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 bg-emerald-500/20 rounded-2xl flex items-center justify-center rotate-6">
                        <Code className="text-emerald-400" size={20} />
                      </div>
                      <div>
                        <h3 className="text-2xl font-bold text-white bg-gradient-to-r from-white via-emerald-100 to-white bg-clip-text text-transparent">
                          Code
                        </h3>
                        <p className="text-emerald-300 mt-1">Apply knowledge</p>
                      </div>
                      <div className="ml-auto px-3 py-1.5 bg-emerald-500/10 text-emerald-300 rounded-full text-sm font-semibold border border-emerald-500/20">
                        45-75 min
                      </div>
                    </div>
                    
                    <div className="bg-emerald-500/8 border border-emerald-500/15 rounded-2xl p-6">
                      <ul className="space-y-4">
                        <li className="flex items-start gap-3 group">
              ...
              <div className="lg:col-span-1">
                <div className="bg-gradient-to-br from-purple-500/8 via-purple-500/4 to-transparent backdrop-blur-sm border border-purple-500/15 rounded-3xl p-6 lg:p-8 sticky top-32 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-10 h-10 bg-purple-500/20 rounded-xl flex items-center justify-center -rotate-12">
    ...
    <div className="bg-gradient-to-br from-blue-500/8 via-blue-500/4 to-transparent backdrop-blur-sm border border-blue-500/15 rounded-3xl p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h2 className="text-2xl lg:text-3xl font-bold text-white bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent">
              Platform Guide
            </h2>
            <p className="text-blue-300 font-medium">How Algomist works</p>
          </div>
        </div>

        <div className="space-y-6">
          <div className="bg-gradient-to-br from-red-500/8 via-red-500/4 to-transparent backdrop-blur-sm border border-red-500/15 rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-emerald-500/8 via-emerald-500/4 to-transparent backdrop-blur-sm border border-emerald-500/15 rounded-2xl p-6 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 group">
                    ...
                    <span className="text-gray-300 group-hover:text-white transition-colors duration-200 text-sm">6-week structured curriculum</span>
                  </li>
                  <li className="flex items-start gap-3 group">
                    <div className="w-1.5 h-1.5 bg-emerald-400 rounded-full mt-2 group-hover:scale-150 transition-transform duration-200"></div>
                    <span className="text-gray-300 group-hover:text-white transition-colors duration-200 text-sm">Progress tracking</span>
                  </li>
                  <li className="flex items-start gap-3 group">
                    <div className="w-1.5 h-1.5 bg-emerald-400 rounded-full mt-2 group-hover:scale-150 transition-transform duration-200"></div>
                    <span className="text-gray-300 group-hover:text-white transition-colors duration-200 text-sm">Curated problem sets</span>
                  </li>
                  <li className="flex items-start gap-3 group">
                    <div className="w-1.5 h-1.5 bg-emerald-400 rounded-full mt-2 group-hover:scale-150 transition-transform duration-200"></div>
                    <span className="text-gray-300 group-hover:text-white transition-colors duration-200 text-sm">Study strategies</span>
                  </li>
                </ul>
              </div>
            </div>

            <div className="bg-gradient-to-br from-orange-500/8 via-orange-500/4 to-transparent backdrop-blur-sm border border-orange-500/15 rounded-2xl p-6 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 group">
                    ...
                    <span className="text-gray-300 group-hover:text-white transition-colors duration-200 text-sm">Code editor & testing</span>
                  </li>
                  <li className="flex items-start gap-3 group">
                    <div className="w-1.5 h-1.5 bg-orange-400 rounded-full mt-2 group-hover:scale-150 transition-transform duration-200"></div>
                    <span className="text-gray-300 group-hover:text-white transition-colors duration-200 text-sm">Solution submissions</span>
                  </li>
                  <li className="flex items-start gap-3 group">
                    <div className="w-1.5 h-1.5 bg-orange-400 rounded-full mt-2 group-hover:scale-150 transition-transform duration-200"></div>
                    <span className="text-gray-300 group-hover:text-white transition-colors duration-200 text-sm">Detailed explanations</span>
                  </li>
                  <li className="flex items-start gap-3 group">
                    <div className="w-1.5 h-1.5 bg-orange-400 rounded-full mt-2 group-hover:scale-150 transition-transform duration-200"></div>
                    <span className="text-gray-300 group-hover:text-white transition-colors duration-200 text-sm">Instant feedback</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-purple-500/8 via-purple-500/4 to-transparent backdrop-blur-sm border border-purple-500/15 rounded-2xl p-6 relative overflow-hidden">
